...
class BTT:
    ...
    def _chart_rsi(self, closes: list):
        ...
        rsi_vals = RSI(pd.Series(closes), 14)
    ...
    def view_ord_hist(self):
        ...
        if not self.exch:
            print(Fore.RED + "CCXT exchange object not initialized.")
            return
        try:
    ...
    def disp_atr(self, symbol: str, timeframe: str, period: int):
        ...
        try:
            ...
            print(Fore.RED + Style.BRIGHT + f"Bybit Exchange Error displaying ATR: {e}")
            logging.error(f"Bybit Exchange Error displaying ATR: {e}")
        except Exception as e:
            print(Fore.RED + Style.BRIGHT + f"Error displaying ATR: {e}")
            logging.error(f"General error displaying ATR: {e}")
        finally:
            input(Fore.YELLOW + Style.BRIGHT + "\nPress Enter...")
